...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('CarSell', '0028_vehicle_photo1_vehicle_photo2_vehicle_photo3_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='CarSell.vehicle')),
